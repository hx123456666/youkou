"""
Django settings for youkou_djT project.
...
SECRET_KEY = 't9-=@h#l=b8wob*w(tz0=c^^c&ehsh1ok@!53c*+1e%lj)$0pr'
...
WSGI_APPLICATION = 'youkou_djT.wsgi.application'
